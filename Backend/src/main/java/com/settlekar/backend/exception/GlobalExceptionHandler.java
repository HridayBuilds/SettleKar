...
import com.settlekar.backend.dto.response.ErrorResponse;
...
public class GlobalExceptionHandler {
    ...
    /**
     * Handle BudgetCapExceededException (400)
     */
    @ExceptionHandler(BudgetCapExceededException.class)
    public ResponseEntity<ErrorResponse> handleBudgetCapExceededException(
            BudgetCapExceededException ex,
            HttpServletRequest request) {

        log.error("Budget cap exceeded: {}", ex.getMessage());
    ...
    /**
     * Handle GroupLockedException (403)
     */
    @ExceptionHandler(GroupLockedException.class)
    public ResponseEntity<ErrorResponse> handleGroupLockedException(
            GroupLockedException ex,
            HttpServletRequest request) {

        log.error("Group locked: {}", ex.getMessage());
    ...
    /**
     * Handle DuplicateUsernameException (409)
     */
